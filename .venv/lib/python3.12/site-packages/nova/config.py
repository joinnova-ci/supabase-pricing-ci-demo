...
class NovaSettings(BaseModel):
    ...
    min_repo_run_interval_sec: int = 0  # Disabled for demo
    ...
    # Safety limits for demo mode
    demo_mode_max_lines: int = 10000
    demo_mode_max_tokens: int = 100000
    ...
    def from_env(cls) -> "NovaSettings":
        ...
        return cls(
            ...
            min_repo_run_interval_sec=_get_int("NOVA_MIN_REPO_RUN_INTERVAL_SEC", 0),
            ...
            default_reasoning_effort=os.environ.get("NOVA_DEFAULT_REASONING_EFFORT", "high"),
            demo_mode_max_lines=_get_int("NOVA_DEMO_MODE_MAX_LINES", 10000),
            demo_mode_max_tokens=_get_int("NOVA_DEMO_MODE_MAX_TOKENS", 100000),
        )
