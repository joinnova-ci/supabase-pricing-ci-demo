...
try:
    ...
    class LLMClient:  # type: ignore
        def complete(self, system: str, user: str, max_tokens: int = 4000) -> str:
            return "Fix failing tests and ensure all tests pass."
...
"""
        ...
        try:
            ...
            response = self.llm.complete(
                ...
                user=prompt,
                max_tokens=100000  # Will be handled by LLMClient with reasoning_effort=high
            )
...
"""
    ...
    def create_pr(self, 
        ...
        try:
            ...
            if requests is None:
                return False, "Requests library not available; cannot create PR via REST."
