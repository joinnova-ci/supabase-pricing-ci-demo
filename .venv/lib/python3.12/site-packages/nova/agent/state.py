...
class AgentState:
    ...
    enforce_safety_limits: bool = True  # Whether to enforce safety limits
    demo_mode: bool = False  # Use relaxed limits for demo repositories
    ci_mode: bool = False  # CI/CD integration mode
